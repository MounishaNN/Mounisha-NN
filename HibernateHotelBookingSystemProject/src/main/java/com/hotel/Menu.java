...
//booking, customer details and payment
	...
	public Payment paymentdetails(Booking robj) {
		...
		LocalDateTime CheckinTime = RoomUtils.convertStringToDate(robj.getCheckinDate(),
				robj.getCheckinTime());
		LocalDateTime CheckoutTime = RoomUtils.convertStringToDate(robj.getCheckoutDate(),
				robj.getCheckoutTime());
